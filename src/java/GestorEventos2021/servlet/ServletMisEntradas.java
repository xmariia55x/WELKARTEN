 ...
 * @author yeray
 */
@WebServlet(name = "ServletMisEntradas", urlPatterns = {"/ServletMisEntradas"})
public class ServletMisEntradas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Evento e = this.eventoFacade.find(new Integer(eventoId));
        List<Entrada> listaEntradas;
        
        listaEntradas = this.entradaFacade.findByEntradasDeUnUsuarioDeUnEvento(u, e);
