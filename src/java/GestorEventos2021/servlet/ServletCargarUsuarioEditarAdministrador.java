 ...
 * @author maria
 */
@WebServlet(name = "ServletEditarUsuarioAdministrador", urlPatterns = {"/ServletCargarUsuarioEditarAdministrador"})
public class ServletCargarUsuarioEditarAdministrador extends HttpServlet {
