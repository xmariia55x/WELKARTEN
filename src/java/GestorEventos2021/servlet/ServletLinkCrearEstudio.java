 ...
 * @author david
 */
@WebServlet(name = "ServletLinkCrearEstudio", urlPatterns = {"/ServletLinkCrearEstudio"})
public class ServletLinkCrearEstudio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("CrearEstudio.jsp");
