 ...
 * @author yeray
 */
@WebServlet(name = "ServletEventoInfo", urlPatterns = {"/ServletEventoInfo"})
public class ServletEventoInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Evento evento = this.eventoFacade.find(Integer.parseInt(strId));
